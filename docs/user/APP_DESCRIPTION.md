...
- Open local HTML and Markdown folders.
- Save multiple places and switch between them.
- Browse pages in a native macOS sidebar.
- Show optional in-page contents navigation.
- Open or reveal source files in Finder.
- Rename, reorder, and remove folder shortcuts without touching files on disk.
...
HTTMELY is not a cloud notes app, website builder, analytics dashboard, or hosted documentation service.

It is a local reader for folders of pages.

The extra layer is that those pages can be generated from almost anything.
